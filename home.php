...
if(isset($_POST['add_to_cart'])){
   ...
   $check_cart_numbers = mysqli_query($conn, "SELECT * FROM `cart` WHERE name = '$product_name' AND user_id = '$id'") or die('query failed');
      ...
      mysqli_query($conn, "UPDATE `cart` SET quantity=quantity+'$product_quantity' WHERE user_id='$id'") or die('query failed');
   }else{
...
<section class="products">
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
      ...
      <input type="number" min="1" name="product_quantity"  class="qty">
